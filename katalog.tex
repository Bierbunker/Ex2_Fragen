...
\begin{figure}[H]
    \centering
    \begin{samepage}
        \includegraphics[width=0.6\textwidth]{image/15/s-p-polarisation.jpg}
...
Lässt man eine Lichtwelle aus einem optisch dichteren Medium 1 ins optische dünnere Medium 2 ($n_1 > n_2$) laufen, so folgt
aus dem Brechungsgesetz für den Winkel $\alpha$:
%
...
\begin{figure}[H]
    ...
    \begin{samepage}
        ...
        dichteren Medium unter Winkeln $\alpha > \alpha_g$ auf die Grenzfläche fallen}
