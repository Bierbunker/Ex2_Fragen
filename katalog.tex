\documentclass[a4paper, 11pt, parskip=half, ngerman]{scrartcl}
...
\label{Materie im elektrischen Feld}
...
\label{Materie im magnetischen Feld}
...
\label{Zeitlich veraenderliche Felder}
...
\label{Elektrische Generatoren und Motoren}
...
\label{Wechselstrom und Drehstrom}
...
\label{Wechselstromkreise und Lineare Netzwerke}
...
\label{Transformator und Gleichrichter}
...
\label{Elektromagnetische Schwingungen und Entstehung von Wellen}
